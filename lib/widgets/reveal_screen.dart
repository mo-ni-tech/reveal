      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            widget.title,
            SizedBox(height: 16),
            if (!widget._imageRevealed)
              Text('Swipe to reveal this picture.',
                  style:
            ...
            if (widget._imageRevealed)
              RaisedButton(
                  ...
                  child: Text('START AGAIN',
                      style: TextStyle(
                          fontSize: 16, color: AppColors.colorGreen))),
            Padding(
                padding: EdgeInsets.fromLTRB(35, 26, 35, 35),
                child: widget._imageRevealed == true
                    ? this.widget.image
                    : RevealArea(
                        onThreshold: _onReveal,
                        overlayImage: this.widget.overlayImage,
